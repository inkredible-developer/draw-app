...
//            
//            let drawDetails = self.drawService.getDrawById(draw_id: self.drawId)
//            let dataSteps = self.stepService.getSteps(angle_id: drawDetails[0].angle_id)
//            
//            let steps = [
//            DrawingStep(
...
//                        self.drawDetails = drawDetails
//                        self.dataSteps = dataSteps
//                        self.steps = steps
//                        self.currentIndex = Int(drawDetails[0].current_step - 1)
//                        self.updateStep()
//                    }
//                }
//    }
